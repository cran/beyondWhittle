...
#' @details See \link[beyondWhittle]{gibbs_AR} for further details on the
...
#' @keywords internal
gibbs_AR_nuisance <- function(data,
                              nuisanceModel,
                              ar.order,
                              Ntotal,
                              burnin,
  ...
  return(structure(list(theta=mcmc_ar$theta,
                        rho=mcmc_ar$psi,
